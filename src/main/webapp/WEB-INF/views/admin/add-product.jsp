...
<head>
    <meta charset="UTF-8">
    <title>Add Product | FashionStore</title>
...
<main class="fs-products-section">
    <div class="fs-container">
        <h1 class="fs-section-title">Add New Product</h1>
        ...
        <form action="${pageContext.request.contextPath}/admin/products/add" method="post"
            ...
            <div style="margin-bottom: 16px;">
                ...
                <input type="text" id="imageUrl" name="imageUrl" required style="width: 100% , height: 250%;">
            </div>

            <button type="submit" class="fs-btn-primary">Save Product</button>
